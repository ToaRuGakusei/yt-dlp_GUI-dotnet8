...
namespace yt_dlp_GUI_dotnet8
{
    public class ViewModel : Prism.Mvvm.BindableBase
    {
        ...
        private ObservableCollection<DLList> _DownloadList = new ObservableCollection<DLList>();
        public ObservableCollection<DLList> DownloadList
        {
            get => _DownloadList;
            set => SetProperty(ref _DownloadList, value, nameof(DownloadList));
        }
    }
}
